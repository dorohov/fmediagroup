...
$(function(){	
	$('.azbn-formsave-form__result').hide();	
	$(document.body).on('submit', '.azbn-formsave-form', {}, function(event){
		...
		$.post('/wp-admin/admin-ajax.php', _form.serialize(), function(data){
			...
			/*form.find('.azbn-formsave-form__result').fadeIn('fast');
			
			setTimeout(function(){
				
				form.find('.azbn-formsave-form__result').fadeOut('fast');
